    ...
    <>
      <main className="h-screen w-full ">
        ...
        <article className="h-screen w-full bg-white">
          ...
          >
            <h1 className="text-center mb-24">Sign up</h1>
            {errorMessage && <p className="text-center text-red-600">{errorMessage.message}</p>}
            <div className=" w-full mt-12">
              <span className=" font-['Montserrat'] font-light">Name</span>
              <input
                type="text"
            ...
            <div className="mt-24 grid place-items-center w-full  ">
              <button
                ...
                type="submit"
              >
                <span className="font-['Montserrat'] font-light">Sign up</span>
              </button>
            </div>
          </form>
        </article>
